...
(function($PS) {
  ...
  var $$int = Routing_Duplex.as(Data_Int.toStringAs(Data_Int.decimal))((function () {
      var $26 = Data_Either.note("Expected an integer value");
      return function ($27) {
  ...
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Utter.Data.Route (line 20, column 1 - line 20, column 48): " + [ x.constructor.name ]);
  }, function (x) {
      ...
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inr) {
          return new EditPanel(x.value0.value0);
      };
      throw new Error("Failed pattern match at Utter.Data.Route (line 20, column 1 - line 20, column 48): " + [ x.constructor.name ]);
  });
...
(function($PS) {
  ...
  var component = function (user) {
      var logo = function (name) {
          return Halogen_HTML_Elements.a([ Utter_Component_Utils.cssClass("nav-item nav-logo"), Halogen_HTML_Properties.href("/") ])([ Halogen_HTML_Core.text(name) ]);
      };
          ...
          return function (dictNavigate) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(Utter_Data_Route.eqRoute))(v1.route)(new Data_Maybe.Just(v.value0)))((function () {
                          ...
                          if (!v2) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $15.route = new Data_Maybe.Just(v.value0);
                                  return $15;
                              });
                          };
              ...
              var handleAction = function (v) {
                  if (v instanceof Initialize) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
                          var $39 = Routing_Duplex.parse(Utter_Data_Route.routeDuplex);
                          return function ($40) {
                              return Data_Either.hush($39($40));
                          };
                          ...
                          return Utter_Capability_Navigate.navigate(Utter_Capability_Navigate.navigateHalogenM(dictNavigate))(Data_Maybe.fromMaybe(Utter_Data_Route.Home.value)(initialRoute));
                      });
                  };
                  if (v instanceof Receive) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $23.user = v.value0.user;
                          return $23;
                      });
                  };
                  throw new Error("Failed pattern match at Utter.Component.Router (line 61, column 18 - line 67, column 34): " + [ v.constructor.name ]);
              };
              var authorize = function (user) {
                  return function (html) {
                      ...
                      throw new Error("Failed pattern match at Utter.Component.Router (line 79, column 25 - line 83, column 11): " + [ user.constructor.name ]);
                  };
              };
              var render = function (v) {
                  if (v.route instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at Utter.Component.Router (line 87, column 15 - line 95, column 27): " + [ v.route.value0.constructor.name ]);
                  };
                  if (v.route instanceof Data_Maybe.Nothing) {
                      return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Page not found!") ]);
                  };
                  throw new Error("Failed pattern match at Utter.Component.Router (line 86, column 28 - line 97, column 44): " + [ v.route.constructor.name ]);
              };
              return Utter_Component_Wrapper.component(dictMonadAff)(dictMonadAsk)()(Halogen_Component.mkComponent({
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref["new"](Data_Maybe.Nothing.value)))(function (user) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Aff_Bus.make(Effect_Class.monadEffectEffect)))(function (userBus) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(Utter_AppM.runAppM(environ))(Utter_Component_Router.component(Utter_AppM.monadAffAppM)(Utter_AppM.monadAskAppM(Type_Equality.refl))(Utter_AppM.navigateAppM)))({})(body))(function (hIO) {
