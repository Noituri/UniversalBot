...
(function($PS) {
  ...
  var getLink = (function () {
      var $7 = Data_Semigroup.append(Data_Semigroup.semigroupString)("#");
      var $8 = Routing_Duplex.print(Utter_Data_Route.routeDuplex);
      return function ($9) {
          return $7($8($9));
      };
  })();
          ...
          return function (dictNavigate) {
              return function (dictLogger) {
                  ...
                  var handleAction = function (v) {
                      ...
                      throw new Error("Failed pattern match at Utter.Page.Panel (line 53, column 20 - line 57, column 54): " + [ v.constructor.name ]);
                  };
                  return Utter_Component_Wrapper.component(dictMonadAff)(dictMonadAsk)()(Halogen_Component.mkComponent({
                      initialState: initialState,
                      render: render,
