  ...
  var component = function (title) {
      return function (options) {
          return function (selected) {
              ...
              return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("card") ])([ Utter_Component_Utils.maybeElem(title)(function (text) {
                  return Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text(text) ]);
              }), Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("horizontal-view") ])(Data_Array.mapWithIndex(option)(options)) ]);
          };
      };
  };
  exports["component"] = component;
...
(function($PS) {
  ...
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Utter_Component_Utils = $PS["Utter.Component.Utils"];                
  var component = function (servers) {
      return function (selected) {
          var getIcon = function (v) {
              return function (v1) {
                  ...
                  return "https://cdn.discordapp.com/icons/" + (v + ("/" + (v1 + ".png")));
              };
          };
          var entry = function (ix) {
              return function (v) {
                  return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass((function () {
                      ...
                      return "";
                  })()) ])([ Halogen_HTML_Elements.img([ Utter_Component_Utils.cssClass("circle"), Halogen_HTML_Properties.src(getIcon(v.id)(v.icon)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(v.name) ]) ]);
              };
          };
          return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("card") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Server Selector") ]), Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("horizontal-view small") ])(Data_Array.mapWithIndex(entry)(servers)) ]);
      };
  };
  exports["component"] = component;
})(PS);
(function($PS) {
  ...
  var render = function (state) {
      return Utter_Component_Container.component(state)("Panel")([ Utter_Component_ServerSelector.component([ {
          id: "1",
          icon: "",
          name: "Test1"
      }, {
          ...
          icon: "",
          name: "Test2"
      } ])(0), Utter_Component_OptionsPanel.component(Data_Maybe.Nothing.value)([ "fa-newspaper", "fa-wrench" ])(0) ]);
  };
  var component = function (dictMonadAff) {
      return function (dictMonadAsk) {
          return function (dictNavigate) {
              ...
              return function (dictLogger) {
                  ...
                  var handleAction = function (v) {
                      if (v instanceof Initialize) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
                              var $40 = Routing_Duplex.parse(Utter_Data_Route.routeDuplex);
                              return function ($41) {
                                  return Data_Either.hush($40($41));
                              };
                      ...
                      if (v instanceof Receive) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              $24.user = v.value0.user;
                              return $24;
                          });
                      };
                      throw new Error("Failed pattern match at Utter.Component.Router (line 65, column 18 - line 71, column 34): " + [ v.constructor.name ]);
                  };
                  var authorize = function (user) {
                      return function (html) {
                          ...
                          throw new Error("Failed pattern match at Utter.Component.Router (line 83, column 25 - line 87, column 11): " + [ user.constructor.name ]);
                      };
                  };
                      ...
                      if (v.route instanceof Data_Maybe.Just) {
                          ...
                          if (v.route.value0 instanceof Utter_Data_Route.Panel) {
                              return authorize(v.user)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                  return "panel";
                              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Utter_Page_Panel.component(dictMonadAff)(dictMonadAsk)(dictNavigate))({})(Data_Void.absurd));
                          };
                          ...
                          throw new Error("Failed pattern match at Utter.Component.Router (line 91, column 15 - line 101, column 75): " + [ v.route.value0.constructor.name ]);
                      };
                      if (v.route instanceof Data_Maybe.Nothing) {
                          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Page not found!") ]);
                      };
                      throw new Error("Failed pattern match at Utter.Component.Router (line 90, column 28 - line 103, column 44): " + [ v.route.constructor.name ]);
                  };
                  return Utter_Component_Wrapper.component(dictMonadAff)(dictMonadAsk)()(Halogen_Component.mkComponent({
                      ...
                      "eval": Halogen_Component.mkEval({
                          ...
                          handleQuery: handleQuery,
                          receive: function ($42) {
                              return Data_Maybe.Just.create(Receive.create($42));
                          },
                          initialize: new Data_Maybe.Just(Initialize.value),
                          finalize: Halogen_Component.defaultEval.finalize
                      })
