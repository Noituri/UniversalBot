...
(function($PS) {
  ...
  var routeDuplex = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoute)(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      return "Home";
...
(function($PS) {
  ...
  var component = function (title) {
      return function (inner) {
          ...
          return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("container") ])(Data_Array.cons(titleHTML)(inner));
      };
  };
          ...
          return function (dictLacks) {
              return function (innerComponent) {
                  ...
                  var handleAction = function (v) {
                      ...
                      throw new Error("Failed pattern match at Utter.Component.Wrapper (line 48, column 18 - line 63, column 21): " + [ v.constructor.name ]);
                  };
      ...
      return function (dictMonadAsk) {
          return function (dictNavigate) {
              var render = function (v) {
                  ...
                  throw new Error("Failed pattern match at Utter.Component.Router (line 77, column 28 - line 82, column 44): " + [ v.route.constructor.name ]);
              };
              ...
              var handleAction = function (v) {
                  if (v instanceof Initialize) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
                          var $36 = Routing_Duplex.parse(Utter_Data_Route.routeDuplex);
                          return function ($37) {
                              return Data_Either.hush($36($37));
                          };
                  ...
                  if (v instanceof Receive) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $29.user = v.value0.user;
                          return $29;
                      });
                  };
                  throw new Error("Failed pattern match at Utter.Component.Router (line 58, column 18 - line 64, column 34): " + [ v.constructor.name ]);
              };
              return Utter_Component_Wrapper.component(dictMonadAff)(dictMonadAsk)()(Halogen_Component.mkComponent({
                  ...
                  "eval": Halogen_Component.mkEval({
                      ...
                      handleQuery: handleQuery,
                      receive: function ($38) {
                          return Data_Maybe.Just.create(Receive.create($38));
                      },
                      initialize: new Data_Maybe.Just(Initialize.value),
                      finalize: Halogen_Component.defaultEval.finalize
                  })
