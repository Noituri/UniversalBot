          ...
          return function (dictNavigate) {
              return function (dictLogger) {
                  ...
                  var handleAction = function (v) {
                      if (v instanceof Initialize) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictLogger.Monad0())(Effect_Class.liftEffect(dictMonadAff.MonadEffect0())(Routing_Hash.getHash)))(function (hashRoute) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
                                  var $41 = Routing_Duplex.parse(Utter_Data_Route.routeDuplex);
                                  return function ($42) {
                                      return Data_Either.hush($41($42));
                                  };
                                  ...
                                  return Utter_Capability_Navigate.navigate(Utter_Capability_Navigate.navigateHalogenM(dictNavigate))(Data_Maybe.fromMaybe(Utter_Data_Route.NotFound.value)(initialRoute));
                              });
                          });
                      };
                      if (v instanceof Receive) {
                      ...
                      throw new Error("Failed pattern match at Utter.Component.Router (line 63, column 20 - line 71, column 36): " + [ v.constructor.name ]);
                  };
                  var authorize = function (user) {
                      return function (html) {
                          ...
                          throw new Error("Failed pattern match at Utter.Component.Router (line 83, column 27 - line 87, column 13): " + [ user.constructor.name ]);
                      };
                  };
                  var render = function (v) {
                      if (v.route instanceof Data_Maybe.Just) {
                          ...
                          throw new Error("Failed pattern match at Utter.Component.Router (line 91, column 17 - line 101, column 77): " + [ v.route.value0.constructor.name ]);
                      };
                      if (v.route instanceof Data_Maybe.Nothing) {
                          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Page not found!") ]);
                      };
                      throw new Error("Failed pattern match at Utter.Component.Router (line 90, column 30 - line 103, column 46): " + [ v.route.constructor.name ]);
                  };
                  return Utter_Component_Wrapper.component(dictMonadAff)(dictMonadAsk)()(Halogen_Component.mkComponent({
