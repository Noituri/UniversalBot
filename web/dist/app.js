...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Capability.Logger"] = $PS["Utter.Capability.Logger"] || {};
  var exports = $PS["Utter.Capability.Logger"];                              
  var Logger = function (Monad0, log) {
      this.Monad0 = Monad0;
      this.log = log;
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Capability.Navigate"] = $PS["Utter.Capability.Navigate"] || {};
  var exports = $PS["Utter.Capability.Navigate"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Data.Route"] = $PS["Utter.Data.Route"] || {};
  var exports = $PS["Utter.Data.Route"];
  var Data_Either = $PS["Data.Either"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Generic_Rep = $PS["Data.Generic.Rep"];
  ...
  var EditPanel = (function () {
      function EditPanel(value0) {
          this.value0 = value0;
      };
      EditPanel.create = function (value0) {
          return new EditPanel(value0);
      };
      return EditPanel;
  })();
  ...
  var $$int = Routing_Duplex.as(Data_Int.toStringAs(Data_Int.decimal))((function () {
      var $32 = Data_Either.note("Expected an integer value");
      return function ($33) {
          return $32(Data_Int.fromString($33));
      };
  })());
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof Panel) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value));
      };
      if (x instanceof EditPanel) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(x.value0)));
      };
      if (x instanceof NotFound) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value)));
      };
      throw new Error("Failed pattern match at Utter.Data.Route (line 21, column 1 - line 21, column 48): " + [ x.constructor.name ]);
  }, function (x) {
      ...
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inl)) {
          return new EditPanel(x.value0.value0.value0);
      };
  ...
  var routeDuplex = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoute)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      return "Home";
      ...
      Panel: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("panel")(Routing_Duplex_Generic.noArgs),
      EditPanel: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteAll))("panel")($$int(Routing_Duplex.segment)),
      NotFound: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("not-found")(Routing_Duplex_Generic.noArgs)
  }));     
  var eqRoute = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof EditPanel && y instanceof EditPanel) {
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.AppM"] = $PS["Utter.AppM"] || {};
  var exports = $PS["Utter.AppM"];
  var Control_Monad_Reader_Class = $PS["Control.Monad.Reader.Class"];
  var Control_Monad_Reader_Trans = $PS["Control.Monad.Reader.Trans"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  ...
  var Utter_Capability_Logger = $PS["Utter.Capability.Logger"];
  var Utter_Capability_Navigate = $PS["Utter.Capability.Navigate"];
  var Utter_Data_Route = $PS["Utter.Data.Route"];                
  var AppM = function (x) {
      return x;
  };
  ...
  var navigateAppM = new Utter_Capability_Navigate.Navigate(function () {
      return monadAppM;
  }, (function () {
      var $4 = Effect_Class.liftEffect(monadEffectAppM);
      var $5 = Routing_Duplex.print(Utter_Data_Route.routeDuplex);
      return function ($6) {
          return $4(Routing_Hash.setHash($5($6)));
      };
  })());
  var monadAffAppM = Effect_Aff_Class.monadAffReader(Effect_Aff_Class.monadAffAff);
  var loggerAppM = new Utter_Capability_Logger.Logger(function () {
      return monadAppM;
  }, function (msg) {
      return Effect_Class.liftEffect(monadEffectAppM)(Effect_Console.log(msg));
  });
  ...
  exports["loggerAppM"] = loggerAppM;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Component.Utils"] = $PS["Utter.Component.Utils"] || {};
  var exports = $PS["Utter.Component.Utils"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Rec_Class = $PS["Control.Monad.Rec.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var isMaybeTrue = function (v) {
      ...
      throw new Error("Failed pattern match at Utter.Component.Utils (line 38, column 1 - line 38, column 40): " + [ v.constructor.name ]);
  };
  var getLink = (function () {
      var $10 = Data_Semigroup.append(Data_Semigroup.semigroupString)("#");
      var $11 = Routing_Duplex.print(Utter_Data_Route.routeDuplex);
      return function ($12) {
          return $10($11($12));
      };
  })();
  ...
  exports["isMaybeTrue"] = isMaybeTrue;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Component.Navbar"] = $PS["Utter.Component.Navbar"] || {};
  var exports = $PS["Utter.Component.Navbar"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Utter_Component_Utils = $PS["Utter.Component.Utils"];
  var Utter_Data_Route = $PS["Utter.Data.Route"];                
  var component = function (user) {
      var logo = function (name) {
          return Halogen_HTML_Elements.a([ Utter_Component_Utils.cssClass("nav-item nav-logo"), Halogen_HTML_Properties.href(Utter_Component_Utils.getLink(Utter_Data_Route.Home.value)) ])([ Halogen_HTML_Core.text(name) ]);
      };
      var item = function (name) {
          return function (path) {
              return Halogen_HTML_Elements.a([ Utter_Component_Utils.cssClass("nav-item"), Halogen_HTML_Properties.href(path) ])([ Halogen_HTML_Core.text(name) ]);
          };
      };
      return Halogen_HTML_Elements.nav_([ logo("UtterBot"), Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("nav-items-container") ])([ item("Invite")(Utter_Component_Utils.getLink(Utter_Data_Route.Home.value)), item("Commands")(Utter_Component_Utils.getLink(Utter_Data_Route.Home.value)), Utter_Component_Utils.whenElem(Data_Maybe.isJust(user))(function (v) {
          return item("Panel")(Utter_Component_Utils.getLink(Utter_Data_Route.Panel.value));
      }), Utter_Component_Utils.whenElem(Data_Maybe.isNothing(user))(function (v) {
          return item("Login")(Utter_Component_Utils.getLink(Utter_Data_Route.Home.value));
      }) ]) ]);
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Component.Container"] = $PS["Utter.Component.Container"] || {};
  var exports = $PS["Utter.Component.Container"];
  var Data_Array = $PS["Data.Array"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Utter_Component_Navbar = $PS["Utter.Component.Navbar"];
  var Utter_Component_Utils = $PS["Utter.Component.Utils"];                
  var component = function (user) {
      return function (title) {
          return function (inner) {
              var titleHTML = Halogen_HTML_Elements.title_([ Halogen_HTML_Core.text("Utter - " + title) ]);
              return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("container") ])(Data_Array.cons(Utter_Component_Navbar.component(user))(Data_Array.cons(titleHTML)(inner)));
          };
      };
  };
  exports["component"] = component;
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Component.FeatureCard"] = $PS["Utter.Component.FeatureCard"] || {};
  var exports = $PS["Utter.Component.FeatureCard"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Utter_Component_Utils = $PS["Utter.Component.Utils"];                
  var component = function (title) {
      return function (desc) {
          return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("card") ])([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text(title) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(desc) ]) ]);
      };
  };
  exports["component"] = component;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Component.ItemsList"] = $PS["Utter.Component.ItemsList"] || {};
  var exports = $PS["Utter.Component.ItemsList"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var ToggleDetails = (function () {
      function ToggleDetails(value0) {
          this.value0 = value0;
      };
      ToggleDetails.create = function (value0) {
          return new ToggleDetails(value0);
      };
      return ToggleDetails;
  })();
  var render = function (v) {
      var entry = function (ix) {
          return function (v1) {
              return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("list-entry"), Halogen_HTML_Events.onClick(function (v2) {
                  return Data_Maybe.Just.create(new ToggleDetails(ix));
              }) ])([ Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("list-text") ])([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text(v1.name) ]), Halogen_HTML_Elements.h5_([ Halogen_HTML_Core.text(v1.description) ]) ]), Utter_Component_Utils.whenElem(Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqInt)(ix)(v.opened))(function (v2) {
                  return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("list-entry list-entry-details") ])([ Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("list-text") ])([ Halogen_HTML_Elements.h5_([ Halogen_HTML_Core.text(v1.details) ]) ]) ]);
              }) ]);
          };
      };
      return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("card") ])([ Utter_Component_Utils.maybeElem(v.title)(function (text) {
          return Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text(text) ]);
      }), Halogen_HTML_Elements.div_(Data_Array.mapWithIndex(entry)(v.entries)) ]);
  };
  var component = function (dictLogger) {
      var initialState = function (v) {
          return {
              title: v.title,
              entries: v.entries,
              opened: Data_Monoid.mempty(Data_Monoid.monoidArray)
          };
      };
      var handleAction = function (v) {
          if (v instanceof HandleInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (oldN) {
                  return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Utter_Component_Utils.isMaybeTrue(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Eq.notEq(Data_Eq.eqString))(oldN.title))(v.value0.title)) || Data_Eq.notEq(Data_Eq.eqArray(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                      return "name";
                  }))(Data_Eq.eqString))()(new Data_Symbol.IsSymbol(function () {
                      return "details";
                  }))(Data_Eq.eqString))()(new Data_Symbol.IsSymbol(function () {
                      return "description";
                  }))(Data_Eq.eqString))))(oldN.entries)(v.value0.entries))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $24 = {};
                      for (var $25 in oldN) {
                          if ({}.hasOwnProperty.call(oldN, $25)) {
                              $24[$25] = oldN[$25];
                          };
                      };
                      $24.title = v.value0.title;
                      $24.entries = v.value0.entries;
                      return $24;
                  })()));
              });
          };
          if (v instanceof ToggleDetails) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                  var $30 = Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqInt)(v.value0)(st.opened);
                  if ($30) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $31.opened = Data_Array.deleteBy(function (v2) {
                              return function (i) {
                                  return v2 === i;
                              };
                          })(v.value0)(st.opened);
                  ...
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $34.opened = Data_Array.cons(v.value0)(st.opened);
                      return $34;
                  });
              });
          };
          throw new Error("Failed pattern match at Utter.Component.ItemsList (line 38, column 20 - line 47, column 52): " + [ v.constructor.name ]);
      };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Component.OptionsPanel"] = $PS["Utter.Component.OptionsPanel"] || {};
  var exports = $PS["Utter.Component.OptionsPanel"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var SelectedOption = (function () {
      function SelectedOption(value0) {
          this.value0 = value0;
      };
      SelectedOption.create = function (value0) {
          return new SelectedOption(value0);
      };
  ...
  var render = function (v) {
      var option = function (ix) {
          return function (icon) {
              return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("panel-option" + (function () {
                  var $7 = ix === v.selected;
                  if ($7) {
                      return " selected";
                  };
                  ...
                  return Data_Maybe.Just.create(new SelectOption(ix));
              }) ])([ Halogen_HTML_Elements.i([ Utter_Component_Utils.cssClass("option-el fas " + icon) ])([  ]) ]);
          };
      };
      return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("card") ])([ Utter_Component_Utils.maybeElem(v.title)(function (text) {
          return Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text(text) ]);
      }), Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("horizontal-view") ])(Data_Array.mapWithIndex(option)(v.options)) ]);
  };
  var component = function (dictNavigate) {
      return function (dictLogger) {
          var handleAction = function (v) {
              if (v instanceof HandleInput) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (oldN) {
                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                          return "title";
                      }))(Data_Maybe.eqMaybe(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
                          return "selected";
                      }))(Data_Eq.eqInt))()(new Data_Symbol.IsSymbol(function () {
                          return "options";
                      }))(Data_Eq.eqArray(Data_Eq.eqString))))(oldN)(v.value0))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0));
                  });
              };
              if (v instanceof SelectOption) {
                  return Halogen_Query_HalogenM.raise(new SelectedOption(v.value0));
              };
              throw new Error("Failed pattern match at Utter.Component.OptionsPanel (line 45, column 20 - line 50, column 35): " + [ v.constructor.name ]);
          };
          return Halogen_Component.mkComponent({
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Component.Wrapper"] = $PS["Utter.Component.Wrapper"] || {};
  var exports = $PS["Utter.Component.Wrapper"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Reader_Class = $PS["Control.Monad.Reader.Class"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Functor = $PS["Data.Functor"];
                  ...
                  var handleAction = function (v) {
                      if (v instanceof Initialize) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Reader_Class.asks(Halogen_Query_HalogenM.monadAskHalogenM(dictMonadAsk))(function (v1) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Data_Functor.map(Halogen_Query_EventSource.functorEventSource(((((dictMonadAff.MonadEffect0()).Monad0()).Bind1()).Apply0()).Functor0()))(HandleUserBus.create)(Utter_Component_Utils.busEventSource(dictMonadAff)(v1.userBus))))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref.read(v1.user)))(function (userData) {
                      ...
                      if (v instanceof Receive) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Record.insert(new Data_Symbol.IsSymbol(function () {
                                  return "user";
                              }))()()(Data_Symbol.SProxy.value)(v1.user)(v.value0));
                          });
                      };
                      if (v instanceof Emit) {
                          return Halogen_Query_HalogenM.raise(v.value0);
                      };
                      throw new Error("Failed pattern match at Utter.Component.Wrapper (line 49, column 18 - line 64, column 21): " + [ v.constructor.name ]);
                  };
                  return Halogen_Component.mkComponent({
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Page.Home"] = $PS["Utter.Page.Home"] || {};
  var exports = $PS["Utter.Page.Home"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Utter_Component_Container = $PS["Utter.Component.Container"];
  var Utter_Component_FeatureCard = $PS["Utter.Component.FeatureCard"];
  var Utter_Component_Utils = $PS["Utter.Component.Utils"];
  var Utter_Component_Wrapper = $PS["Utter.Component.Wrapper"];                
  var Receive = (function () {
      function Receive(value0) {
          this.value0 = value0;
      };
  ...
  var render = function (state) {
      return Utter_Component_Container.component(state)("Home")([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1([ Utter_Component_Utils.cssClass("heading") ])([ Halogen_HTML_Core.text("Utter") ]), Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("The Universal Bot") ]), Halogen_HTML_Elements.p([ Utter_Component_Utils.cssClass("gradient-btn") ])([ Halogen_HTML_Core.text("Try it!") ]) ]), Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("top-margin") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Features") ]), Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("features") ])([ Utter_Component_FeatureCard.component("Powerful")("Need moderation, utilities or tickets? We've got you covered! UtterBot offers many commands categorised into modules."), Utter_Component_FeatureCard.component("Configurable")("Don't need some commands? Disable them!\x0aNeed only ticket commands? Just enable ticket module!"), Utter_Component_FeatureCard.component("Web Panel")("Configure UtterBot from your web browser. Check the moderation logs!"), Utter_Component_FeatureCard.component("Open Source")("Want to check the code out? Or contribute to the project? Everything is open-source. Feel free to dive in to the project!") ]) ]) ]);
  };
  var component = function (dictMonadAff) {
      return function (dictMonadAsk) {
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Page.NotFound"] = $PS["Utter.Page.NotFound"] || {};
  var exports = $PS["Utter.Page.NotFound"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  ...
  var render = function (state) {
      return Utter_Component_Container.component(state)("Not Found")([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1([ Utter_Component_Utils.cssClass("top-margin") ])([ Halogen_HTML_Core.text("Not sure what you were looking for. But it's not here :/") ]), Halogen_HTML_Elements.p([ Utter_Component_Utils.cssClass("gradient-btn"), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(GoBack.value);
      }) ])([ Halogen_HTML_Core.text("Take me back!") ]) ]) ]);
  };
  var component = function (dictMonadAff) {
      return function (dictMonadAsk) {
          return function (dictNavigate) {
              return function (dictLogger) {
                  ...
                  var handleAction = function (v) {
                      ...
                      if (v instanceof GoBack) {
                          return Utter_Capability_Navigate.navigate(Utter_Capability_Navigate.navigateHalogenM(dictNavigate))(Utter_Data_Route.Home.value);
                      };
                      throw new Error("Failed pattern match at Utter.Page.NotFound (line 47, column 20 - line 51, column 22): " + [ v.constructor.name ]);
                  };
                  return Utter_Component_Wrapper.component(dictMonadAff)(dictMonadAsk)()(Halogen_Component.mkComponent({
                      initialState: initialState,
                      render: render,
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Component.ServerSelector"] = $PS["Utter.Component.ServerSelector"] || {};
  var exports = $PS["Utter.Component.ServerSelector"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var SelectServer = (function () {
      function SelectServer(value0) {
          this.value0 = value0;
      };
      SelectServer.create = function (value0) {
          return new SelectServer(value0);
      };
      return SelectServer;
  })();
  var render = function (v) {
      var getIcon = function (v1) {
          return function (v2) {
              if (v2 === "") {
                  return "https://cdn.discordapp.com/embed/avatars/0.png";
              };
              return "https://cdn.discordapp.com/icons/" + (v1 + ("/" + (v2 + ".png")));
          };
      };
      var entry = function (ix) {
          return function (v1) {
              return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass((function () {
                  var $14 = ix === v.selected;
                  if ($14) {
                      return "selected";
                  };
                  return "";
              })()), Halogen_HTML_Events.onClick(function (v2) {
                  return Data_Maybe.Just.create(new SelectServer(ix));
              }) ])([ Halogen_HTML_Elements.img([ Utter_Component_Utils.cssClass("circle"), Halogen_HTML_Properties.src(getIcon(v1.id)(v1.icon)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(v1.name) ]) ]);
          };
      };
      return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("card") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Server Selector") ]), Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("horizontal-view small") ])(Data_Array.mapWithIndex(entry)(v.servers)) ]);
  };
  var component = function (dictNavigate) {
      return function (dictLogger) {
          var handleAction = function (v) {
              if (v instanceof HandleInput) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (oldN) {
                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                          return "servers";
                          ...
                          return "selected";
                      }))(Data_Eq.eqInt)))(oldN)(v.value0))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0));
                  });
              };
              if (v instanceof SelectServer) {
                  return Utter_Capability_Navigate.navigate(Utter_Capability_Navigate.navigateHalogenM(dictNavigate))(new Utter_Data_Route.EditPanel(v.value0));
              };
              throw new Error("Failed pattern match at Utter.Component.ServerSelector (line 39, column 20 - line 44, column 31): " + [ v.constructor.name ]);
          };
          return Halogen_Component.mkComponent({
              initialState: Control_Category.identity(Control_Category.categoryFn),
              render: render,
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Component.ServerSettings"] = $PS["Utter.Component.ServerSettings"] || {};
  var exports = $PS["Utter.Component.ServerSettings"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Eq = $PS["Data.Eq"];
  ...
  var Utter_Component_Utils = $PS["Utter.Component.Utils"];
  var render = function (v) {
      return Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("card") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Settings") ]), Halogen_HTML_Elements.div([ Utter_Component_Utils.cssClass("settings-container") ])([ Halogen_HTML_Elements.h4_([ Halogen_HTML_Core.text("Prefix") ]), Halogen_HTML_Elements.input([ Utter_Component_Utils.cssClass("input-field"), Halogen_HTML_Properties.placeholder("Bot Prefix"), Halogen_HTML_Properties.value(v.prefix) ]), Halogen_HTML_Elements.h4_([ Halogen_HTML_Core.text("Muted Role") ]), Halogen_HTML_Elements.input([ Utter_Component_Utils.cssClass("input-field"), Halogen_HTML_Properties.placeholder("Muted Role"), Halogen_HTML_Properties.value(v.mutedRole) ]), Halogen_HTML_Elements.h4_([ Halogen_HTML_Core.text("Mod-logs Channel") ]), Halogen_HTML_Elements.input([ Utter_Component_Utils.cssClass("input-field"), Halogen_HTML_Properties.placeholder("Mod-logs Channel"), Halogen_HTML_Properties.value(v.modLogsChannel) ]), Halogen_HTML_Elements.p([ Utter_Component_Utils.cssClass("top-margin gradient-btn") ])([ Halogen_HTML_Core.text("Save") ]) ]) ]);
  };
  var component = function (dictNavigate) {
      ...
      var handleAction = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "modLogsChannel";
              }))(Data_Eq.eqString)))(st)(v.value0))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0));
          });
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Page.Panel"] = $PS["Utter.Page.Panel"] || {};
  var exports = $PS["Utter.Page.Panel"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Symbol = $PS["Data.Symbol"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Utter_Component_Container = $PS["Utter.Component.Container"];
  var Utter_Component_ItemsList = $PS["Utter.Component.ItemsList"];
  var Utter_Component_OptionsPanel = $PS["Utter.Component.OptionsPanel"];
  var Utter_Component_ServerSelector = $PS["Utter.Component.ServerSelector"];
  var Utter_Component_ServerSettings = $PS["Utter.Component.ServerSettings"];
  var Utter_Component_Wrapper = $PS["Utter.Component.Wrapper"];                
  var Receive = (function () {
      function Receive(value0) {
          this.value0 = value0;
  ...
  var HandleOptionMessage = (function () {
      function HandleOptionMessage(value0) {
          this.value0 = value0;
      };
      HandleOptionMessage.create = function (value0) {
          return new HandleOptionMessage(value0);
      };
      return HandleOptionMessage;
  })();
  var component = function (dictMonadAff) {
      return function (dictMonadAsk) {
          return function (dictNavigate) {
              return function (dictLogger) {
                  var render = function (v) {
                      return Utter_Component_Container.component(v.user)("Panel")([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "serverSelector";
                      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Utter_Component_ServerSelector.component(dictNavigate)(dictLogger))({
                          servers: [ {
                              id: "1",
                              icon: "",
                              name: "Test1"
                          ...
                          return "optionsPanel";
                      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Utter_Component_OptionsPanel.component(dictNavigate)(dictLogger))({
                          title: Data_Maybe.Nothing.value,
                          options: [ "fa-newspaper", "fa-wrench" ],
                          selected: v.selectedOption
                      })(function ($27) {
                          return Data_Maybe.Just.create(HandleOptionMessage.create($27));
                      }), (function () {
                          if (v.selectedOption === 0) {
                              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                  return "itemsList";
                              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Utter_Component_ItemsList.component(dictLogger))({
                                  title: new Data_Maybe.Just("Actions"),
                                  entries: [ {
                                      name: "Ban",
                                      description: "User xxx has been banned by yyy!",
                                      details: "Banned for breaking 'z' rule."
                                  }, {
                                      name: "Ban",
                                      description: "User xyx has been banned by yxy!",
                                      details: "Banned for breaking 'w' rule."
                                  } ]
                              })(Data_Void.absurd);
                          };
                          if (v.selectedOption === 1) {
                              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                  return "serverSettings";
                              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Utter_Component_ServerSettings.component(dictNavigate))({
                                  prefix: "!",
                  ...
                  var handleAction = function (v) {
                      ...
                      if (v instanceof HandleOptionMessage) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $22.selectedOption = v.value0.value0;
                              return $22;
                          });
                      };
                      throw new Error("Failed pattern match at Utter.Page.Panel (line 63, column 20 - line 68, column 56): " + [ v.constructor.name ]);
                  };
                  return Utter_Component_Wrapper.component(dictMonadAff)(dictMonadAsk)()(Halogen_Component.mkComponent({
                      initialState: initialState,
                      render: render,
                      "eval": Halogen_Component.mkEval({
                          ...
                          handleQuery: Halogen_Component.defaultEval.handleQuery,
                          receive: function ($28) {
                              return Data_Maybe.Just.create(Receive.create($28));
                          },
                          initialize: Halogen_Component.defaultEval.initialize,
                          finalize: Halogen_Component.defaultEval.finalize
                      })
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Component.Router"] = $PS["Utter.Component.Router"] || {};
  var exports = $PS["Utter.Component.Router"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  ...
  var Utter_Component_Wrapper = $PS["Utter.Component.Wrapper"];
  var Utter_Data_Route = $PS["Utter.Data.Route"];
  var Utter_Page_Home = $PS["Utter.Page.Home"];
  var Utter_Page_NotFound = $PS["Utter.Page.NotFound"];
  var Utter_Page_Panel = $PS["Utter.Page.Panel"];                
          ...
          return function (dictNavigate) {
              return function (dictLogger) {
                  var handleQuery = function (v) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(Utter_Data_Route.eqRoute))(v1.route)(new Data_Maybe.Just(v.value0)))((function () {
                              var v2 = Data_Maybe.isJust(v1.user) && false;
                              if (!v2) {
                  ...
                  var handleAction = function (v) {
                      if (v instanceof Initialize) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictLogger.Monad0())(Effect_Class.liftEffect(dictMonadAff.MonadEffect0())(Routing_Hash.getHash)))(function (hashRoute) {
                              var $24 = Data_String_Common["null"](hashRoute);
                              if ($24) {
                                  return Utter_Capability_Navigate.navigate(Utter_Capability_Navigate.navigateHalogenM(dictNavigate))(Utter_Data_Route.Home.value);
                              };
                              return Utter_Capability_Navigate.navigate(Utter_Capability_Navigate.navigateHalogenM(dictNavigate))(Data_Maybe.fromMaybe(Utter_Data_Route.NotFound.value)(Data_Either.hush(Routing_Duplex.parse(Utter_Data_Route.routeDuplex)(hashRoute))));
                          });
                      };
                      if (v instanceof Receive) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              $25.user = v.value0.user;
                              return $25;
                          });
                      };
                      throw new Error("Failed pattern match at Utter.Component.Router (line 63, column 20 - line 70, column 36): " + [ v.constructor.name ]);
                  };
                  var authorize = function (user) {
                      return function (html) {
                          if (user instanceof Data_Maybe.Nothing) {
                              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                  return "home";
                              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Utter_Page_Home.component(dictMonadAff)(dictMonadAsk)(dictNavigate))({})(Data_Void.absurd);
                          };
                          if (user instanceof Data_Maybe.Just) {
                              return html;
                          };
                          throw new Error("Failed pattern match at Utter.Component.Router (line 82, column 27 - line 86, column 13): " + [ user.constructor.name ]);
                      };
                  };
                  var render = function (v) {
                      if (v.route instanceof Data_Maybe.Just) {
                          if (v.route.value0 instanceof Utter_Data_Route.Home) {
                              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                  return "home";
                              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Utter_Page_Home.component(dictMonadAff)(dictMonadAsk)(dictNavigate))({})(Data_Void.absurd);
                          };
                          if (v.route.value0 instanceof Utter_Data_Route.Panel) {
                              return authorize(v.user)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                  return "panel";
                              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Utter_Page_Panel.component(dictMonadAff)(dictMonadAsk)(dictNavigate)(dictLogger))({})(Data_Void.absurd));
                          };
                          if (v.route.value0 instanceof Utter_Data_Route.EditPanel) {
                              return authorize(v.user)(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                  return "panel";
                              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Utter_Page_Panel.component(dictMonadAff)(dictMonadAsk)(dictNavigate)(dictLogger))({})(Data_Void.absurd));
                          };
                          if (v.route.value0 instanceof Utter_Data_Route.NotFound) {
                              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                  return "notFound";
                              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Utter_Page_NotFound.component(dictMonadAff)(dictMonadAsk)(dictNavigate)(dictLogger))({})(Data_Void.absurd);
                          };
                          throw new Error("Failed pattern match at Utter.Component.Router (line 90, column 17 - line 100, column 77): " + [ v.route.value0.constructor.name ]);
                      };
                      if (v.route instanceof Data_Maybe.Nothing) {
                          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Page not found!") ]);
                      };
                      throw new Error("Failed pattern match at Utter.Component.Router (line 89, column 30 - line 102, column 46): " + [ v.route.constructor.name ]);
                  };
                  return Utter_Component_Wrapper.component(dictMonadAff)(dictMonadAsk)()(Halogen_Component.mkComponent({
                      ...
                      "eval": Halogen_Component.mkEval({
                          ...
                          handleQuery: handleQuery,
                          receive: function ($41) {
                              return Data_Maybe.Just.create(Receive.create($41));
                          },
                          initialize: new Data_Maybe.Just(Initialize.value),
                          finalize: Halogen_Component.defaultEval.finalize
                      })
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Utter.Main"] = $PS["Utter.Main"] || {};
  var exports = $PS["Utter.Main"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Either = $PS["Data.Either"];
  var Data_Eq = $PS["Data.Eq"];
  ...
  var Routing_Hash = $PS["Routing.Hash"];
  var Type_Equality = $PS["Type.Equality"];
  var Utter_AppM = $PS["Utter.AppM"];
  var Utter_Component_Router = $PS["Utter.Component.Router"];
  var Utter_Data_Route = $PS["Utter.Data.Route"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref["new"](new Data_Maybe.Just({
          username: "Test",
          token: "TestToken"
      }))))(function (user) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Aff_Bus.make(Effect_Class.monadEffectEffect)))(function (userBus) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(Utter_AppM.runAppM(environ))(Utter_Component_Router.component(Utter_AppM.monadAffAppM)(Utter_AppM.monadAskAppM(Type_Equality.refl))(Utter_AppM.navigateAppM)(Utter_AppM.loggerAppM)))({})(body))(function (hIO) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matchesWith(Data_Either.foldableEither)(Routing_Duplex.parse(Utter_Data_Route.routeDuplex))(function (old) {
                      return function ($$new) {
                          return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(Utter_Data_Route.eqRoute))(old)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(hIO.query(Halogen_Query.tell(Utter_Component_Router.Navigate.create($$new)))));
                      };
                  }))))(function () {
