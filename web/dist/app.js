...
(function($PS) {
  ...
  var render = function (state) {
      return Utter_Component_Container.component(state)("Panel")([ Utter_Component_OptionsPanel.component(Data_Maybe.Nothing.value)([ "fa-newspaper", "fa-wrench" ])(0) ]);
  };
  var component = function (dictMonadAff) {
      return function (dictMonadAsk) {
          return function (dictNavigate) {
          ...
          return function (dictNavigate) {
              return function (dictLogger) {
                  ...
                  var handleAction = function (v) {
                      ...
                      throw new Error("Failed pattern match at Utter.Component.Router (line 62, column 18 - line 68, column 34): " + [ v.constructor.name ]);
                  };
                  var authorize = function (user) {
                      return function (html) {
                          ...
                          throw new Error("Failed pattern match at Utter.Component.Router (line 80, column 25 - line 84, column 11): " + [ user.constructor.name ]);
                      };
                  };
                  var render = function (v) {
                      if (v.route instanceof Data_Maybe.Just) {
                          ...
                          throw new Error("Failed pattern match at Utter.Component.Router (line 88, column 15 - line 98, column 75): " + [ v.route.value0.constructor.name ]);
                      };
                      if (v.route instanceof Data_Maybe.Nothing) {
                          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Page not found!") ]);
                      };
                      throw new Error("Failed pattern match at Utter.Component.Router (line 87, column 28 - line 100, column 44): " + [ v.route.constructor.name ]);
                  };
                  return Utter_Component_Wrapper.component(dictMonadAff)(dictMonadAsk)()(Halogen_Component.mkComponent({
