...
(function($PS) {
  ...
  var loggerHalogenM = function (dictLogger) {
      return new Logger(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, (function () {
          var $1 = Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictLogger.Monad0());
          var $2 = log(dictLogger);
          return function ($3) {
              return $1($2($3));
          };
      })());
  ...
  exports["log"] = log;
  exports["loggerHalogenM"] = loggerHalogenM;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  ...
  var component = function (dictNavigate) {
      return function (dictLogger) {
          var handleAction = function (v) {
              ...
              throw new Error("Failed pattern match at Utter.Component.OptionsPanel (line 42, column 20 - line 47, column 35): " + [ v.constructor.name ]);
          };
          return Halogen_Component.mkComponent({
  ...
  var component = function (dictMonadAff) {
      return function (dictMonadAsk) {
          return function (dictNavigate) {
              return function (dictLogger) {
                  var render = function (state) {
                      return Utter_Component_Container.component(state)("Panel")([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          ...
                          return Data_Maybe.Just.create(HandleOptionMessage.create($15));
